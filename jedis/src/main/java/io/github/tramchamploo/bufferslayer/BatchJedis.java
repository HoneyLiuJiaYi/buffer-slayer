...
import io.github.tramchamploo.bufferslayer.RedisCommand.Blpop;
import io.github.tramchamploo.bufferslayer.RedisCommand.Brpop;
...
import io.github.tramchamploo.bufferslayer.RedisCommand.Del;
import io.github.tramchamploo.bufferslayer.RedisCommand.Echo;
import io.github.tramchamploo.bufferslayer.RedisCommand.Exists;
...
public class BatchJedis {
  ...
  public MessageFuture<Boolean> exists(String key) {
    return ResponseUtil.transformResponse(
  ...
  public MessageFuture<Boolean> exists(byte[] key) {
    return ResponseUtil.transformResponse(reporter.report(new Exists(key)), BuilderFactory.BOOLEAN);
  }
